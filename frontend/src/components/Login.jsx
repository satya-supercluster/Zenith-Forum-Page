    ...
    <div className="flex items-center justify-center h-screen bg-gray-100">
      <div className="bg-white m-5 p-8 rounded-lg shadow-md shadow-blue-300 leading-1 sm:w-1/2 lg:w-1/3">
        ...
        <button
          ...
          className="flex max-sm:text-sm flex-col items-center justify-center w-full bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-red-600 transition-colors shadow-md"
        >
